...
from MultiTask import MultiTaskDataset, MultiTaskModel
    ...
    if args.do_train:
        ...
        for task_name,processor in processors.items():
            ...
            if task_name in task_class["csc"]:
                ...
                label_list = MultiTaskDataset.InputExample.get_label_list(train_examples_)
                print(label_list)
        ...
        if args.do_eval:
            ...
            if task_name in task_class["csc"]:
                ...
                assert(task_name in task_class["seq"])
                label_list = MultiTaskDataset.InputExample.get_label_list(eval_examples)
